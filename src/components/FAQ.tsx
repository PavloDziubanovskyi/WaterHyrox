...
const faqItems = [
  ...
  },
  {
    ...
    answer: 'Кошти поверненню не підлягають, але ви можете знайти заміну на своє місце — передати реєстрацію іншому учаснику, повідомивши організаторів.',
  },
  {
  ...
  },
  {
    ...
    answer: 'Вхід для вболівальників — за тарифами локації «Ловивітер». При цьому всі вболівальники можуть користуватися всіма перевагами закладу: плавати, грати в ігри, брати участь в активностях тощо.',
  },
];
