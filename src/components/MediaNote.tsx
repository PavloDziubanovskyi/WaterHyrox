        ...
        >
          ...
          <div className="flex-1">
            ...
            <p className="font-body text-sm md:text-base text-white/60 leading-relaxed">
              На заході присутній офіційний фотограф та/або відеооператор. Зйомка вільна — учасники, глядачі та представники ЗМІ можуть здійснювати фото- та відеозйомку без спеціального дозволу організаторів.
            </p>
          </div>
        </motion.div>
      </div>
